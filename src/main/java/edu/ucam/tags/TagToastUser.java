...
public class TagToastUser extends TagSupport {
	private static final long serialVersionUID = 1L;

	@Override
	public int doStartTag() throws JspException {
		if(pageContext.getServletContext().getAttribute("MSGU") != null) {
			try {
				...
				pageContext.getOut().print("<p>"+pageContext.getServletContext().getAttribute("MSGU")+"</p>");
				pageContext.getOut().print("</div>");
				pageContext.getOut().print("</div>");
				pageContext.getOut().print("</div>");
			} catch (IOException e) {
